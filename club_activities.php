<?php // club_activities.php - Club Activities Page ?>
        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-3/4 lg:w-4/5">
                <div class="flex flex-col sm:flex-row justify-between items-center mb-8">
                    ...
                    <button class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-5 rounded-lg shadow-md transition duration-300 flex items-center">
...
<script>
    // Any specific JS for the club activities page can go here
</script>
</body>
</html>
